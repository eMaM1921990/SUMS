<%-- 
    Document   : Activated
    Created on : Feb 11, 2015, 2:15:11 AM
    Author     : emam
--%>
  ...
  <body class="error">
	<div id="wrapper">
		...
		<div class="error-container">
			<div class="container">
				<div class="error-box">
					<h1 class="error-code"><i class="fa fa-star smaller-50"></i> Success <small>Account activated </small></h1>
					<h3>Thanks!</h3>
