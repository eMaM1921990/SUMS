                            ...
                            <li class="dropdown user-box">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <c:if test="${login.username!=null}">
                                        <span class="user-info"><c:out value="${login.username}"/></span>
                                    </c:if>
                                        ...
                                        <div class="portlet"><!-- /Portlet -->
                                            ...
                                            <div id="basic" class="panel-collapse collapse in">
                                                <div class="portlet-body no-padding">
                                                    <table aria-describedby="SampleDT_info" id="SampleDT" class="datatable table table-hover table-striped table-bordered tc-table dataTable no-footer">
                                                        <thead>
                                                            <tr>
