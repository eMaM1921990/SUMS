 ...
 * @author emam
 */
public class ViewEditIdea extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("aim", request.getParameter("aims").trim());
        request.setAttribute("id", request.getParameter("id").trim());
        request.setAttribute("acq", request.getParameter("acquestion").trim());
        request.setAttribute("nof", request.getParameter("nof").trim());
